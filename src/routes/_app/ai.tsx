    ...
    <div className="h-full overflow-auto bg-base-100 px-4 py-12 md:px-6 md:py-16 pb-24 md:pb-12">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-sm text-base-content/70 leading-relaxed">
          Connect your AI agent to TheGoodSite SEO. Run keyword research, SERP analysis,
        ...
        {getAuthMode(import.meta.env.AUTH_MODE) === "cloudflare_access" ? (
          <div className="alert alert-warning mt-6 text-sm" role="alert">
            ...
            <span>
              ...
              <a
                href="https://thegoodsite.co/docs/self-hosting/cloudflare#connect-the-mcp-server-through-cloudflare-access"
                target="_blank"
                rel="noreferrer"
        ...
        <section className="mt-8">
          ...
          <p className="mt-2.5 text-xs text-base-content/55 leading-relaxed">
            Paste this into any MCP client. This URL points at the TheGoodSite SEO
            instance you are using now, whether hosted, self-hosted, or local.
            Sign in with TheGoodSite SEO when prompted.
          </p>
        </section>
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              <ol className="ml-5 list-decimal space-y-1.5 text-sm text-base-content/70 leading-relaxed">
                ...
                <li>Approve the TheGoodSite SEO login when prompted.</li>
                <li>
                  Optional: after TheGoodSite SEO connects, click{" "}
                  <span className="font-medium text-base-content">
                    Configure
                  </span>
                  , then choose{" "}
        ...
        <section className="mt-12">
          <h2 className="text-base font-semibold">TheGoodSite SEO Skills</h2>
          <p className="mt-1.5 text-sm text-base-content/70 leading-relaxed">
            ...
            call your TheGoodSite SEO MCP tools when live SERP, keyword, backlink, or
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <p className="text-sm text-base-content/70">
                You can also auto-accept each TheGoodSite SEO skill:
              </p>
            ...
            {[
              {
                ...
                description:
                  "Ask questions and run research without leaving TheGoodSite SEO",
              },
              {
