...
function createOpenSeoMcpServer() {
  const server = new McpServer(
    {
      name: "TheGoodSite SEO MCP",
      title: "TheGoodSite SEO",
      version: "0.0.11",
      description:
      ...
      websiteUrl: "https://thegoodsite.co",
      icons: [
        {
          src: "https://thegoodsite.co/android-chrome-512x512.png",
          mimeType: "image/png",
          sizes: ["512x512"],
        },
      ],
    ...
    {
      instructions:
        "TheGoodSite SEO research tools use credits. Proceed with normal focused research, but ask the user for confirmation before planned batches over 2,000 credits.",
    },
  );
