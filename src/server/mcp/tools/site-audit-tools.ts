...
export const getAuditStatusTool = {
  ...
  config: {
    ...
    description:
      "Check the progress of a site audit (phase, pages crawled, Lighthouse progress). Free — reads TheGoodSite SEO state. Omit auditId for the most recent audit.",
...
export const getAuditIssuesTool = {
  ...
  config: {
    ...
    description:
      "Read the prioritized issue report from a completed site audit. Every issue carries a how_to_fix with concrete remediation steps an agent can act on. Free — reads TheGoodSite SEO state. Omit auditId for the most recent audit.",
...
export const getAuditPagesTool = {
  ...
  config: {
    ...
    description:
      "List crawled pages from a site audit with per-page SEO data (status, title, description, word count, indexability, crawl depth, link counts). Free — reads TheGoodSite SEO state. Omit auditId for the most recent audit.",
