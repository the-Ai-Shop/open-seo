 ...
 * free site-reading tools. Every tool the TheGoodSite SEO MCP server exposes is
...
export function buildSamMcpTools(
  ...
  return {
    ...
    get_product_info: tool({
      description:
        "The TheGoodSite SEO fact sheet: what the product does, plans/pricing, credit costs, integrations, MCP setup. Call before answering questions about TheGoodSite SEO itself. Uses no credits.",
      inputSchema: z.object({}),
