...
export const AUDIT_ISSUE_TYPES = {
  "blocked-page": {
    ...
    howToFix:
      'If you own this site, allowlist the "TheGoodSite SEO-Audit" user agent in your WAF/bot-protection settings (on Cloudflare: a WAF custom rule that skips bot protection when the user agent contains "TheGoodSite SEO-Audit"; on some free tiers you may need to relax bot protection). Then re-run the audit.',
  },
  "server-error": {
    severity: "critical",
