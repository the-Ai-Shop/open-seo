...
const STANDARD_MESSAGES: Record<ErrorCode, string> = {
  ...
  AUTH_CONFIG_MISSING:
    "TheGoodSite SEO auth is not configured. Follow the README setup steps for Cloudflare Access.",
  PAYMENT_REQUIRED:
    "An active hosted subscription is required before you can use TheGoodSite SEO.",
